...
public class KassapaateTest {
    ...
    public void kortilleLadataanJosSummaPos() {
        kassa.lataa(kortti, Kassapaate.lataapos);
        
        verify(kortti, times(1)).lataa(Kassapaate.lataapos);
    }
    
    @Test
    public void kortilleEiLadataJosSummaNeg() {
        kassa.lataa(kortti, Kassapaate.lataaneg);
        
        verify(kortti, times(0)).lataa(Kassapaate.lataaneg);
    }
